...
const headers = ["ProductoID","Nombre", "Descripción", "Precio", "Stock","img"]; // Encabezados de la tabla
...
fetch(apiURL)
  ...
  .then(data => {
    ...
    data.forEach(producto => {
      ...
      const celdaProductoID = document.createElement("td");
      celdaProductoID.textContent = producto.ProductoID;
      fila.appendChild(celdaProductoID);
      ...
      celdaimg.textContent = producto.img;
